...
여기에 [다음 내용](https://github.com/govin08/govin08.github.io/blob/master/_includes/head/custom.html)을 입력한 후 저장합니다.
(이 코드를 문자 입력하고 싶은데 잘 되지 않아, 부득이하게 링크로 대체합니다.)
...
It is worthwhile noting that $gH$ form a group itself ; we denote this new group by $G/H$.
Let
...
# 참고자료들
 ...
 - [mathjax 공식 홈페이지](https://www.mathjax.org/)
    - `mathjax`를 제대로 활용하려면 응당 정독해야할만한 공식 documentation입니다만, 아직 다 읽지 못했습니다.
...
- `newcommand`, `newenvironment`와 같은 명령어가 적용되었으면 좋겠다.
- TeX에 나타나는 각종 패키지들이 얼마나 사용될 수 있을지 모르겠다.